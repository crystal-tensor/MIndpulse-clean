...
export const AssetAllocationTranslations: Record<Language, AssetAllocationTranslation> = {
  ...
  en: {
    ...
    subtitle: 'Asset Allocation',
    description: 'Quantum Intelligent Asset Allocation Optimization',
    ...
    report: {
      ...
      summarySection: {
        goalSummary: 'Investment Goal Summary',
        assetSummary: 'Asset Allocation Summary',
        riskSummary: 'Risk Constraint Summary',
      },
    },
